...
public class Preferences {
    ...
    public static String getRegisteredUser(Context context) {
        return getSharedPreference(context).getString(KEY_USER_TEREGISTER, "user");
    }
     ...
     */
    public static void setRegisteredPassword(Context context, String password) {
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
    ...
    public static String getRegisteredPassword(Context context) {
        return getSharedPreference(context).getString(KEY_PASS_TEREGISTER, "pass");
    }
    ...
    public static String getLoggedInUser(Context context) {
        return getSharedPreference(context).getString(KEY_USERNAME_SEDANG_LOGIN, "User New");
    }
    ...
    /*
    Deklarasi Edit Preferences dan memghapus data, sehingga menjadikannya bernilai default
